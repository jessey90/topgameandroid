...
class super_recent_posts_widget extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        <div class="super_recent_posts_item">
                ...
                if ($show_thumbnail) {
                    ...
                    if ($img) {
                        ...
                        <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>">
                            <img class="alignleft"
                                 src="<?php echo plugins_url() ?>/super-recent-posts/timthumb/timthumb.php?src=<?php echo $img ?>&amp;w=<?php echo $thumbnail_w ?>&amp;h=<?php echo $thumbnail_h ?>&amp;zc=1"
                                 alt="<?php the_title(); ?>" width="<?php echo $thumbnail_w ?>"
                                 height="<?php echo $thumbnail_h ?>"/>
                        </a>
                        <?php } ?>
            ...
            ?>
            <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" class="super_recent_posts_item_title"
               style="line-height: 29px"><?php the_title(); ?></a>
    ...
    <p>
        ...
        <select multiple="multiple" onchange="return onchangeTerm('<?php echo $term_field ?>',jQuery(this).val());"
                id="<?php echo $this->get_field_id('taxonomy'); ?>"
                name="<?php echo $this->get_field_name('taxonomy'); ?>[]" style="width:90%;">
            <?php
    ...
    <p>
        ...
        <select multiple="multiple" id="<?php echo $term_field ?>" name="<?php echo $this->get_field_name('term'); ?>[]"
                style="width:90%;">
            <?php
    ...
    <p>
        ...
        <select multiple="multiple" id="<?php echo $this->get_field_id('posttype'); ?>"
                name="<?php echo $this->get_field_name('posttype'); ?>[]" style="width:90%;">
            <?php
    ...
    <p>
        ...
        <input id="<?php echo $this->get_field_id('posts'); ?>" name="<?php echo $this->get_field_name('posts'); ?>"
               value="<?php echo $instance['posts'] ?>" style="width:20px">

    </p>

    <div style="float:left;display:inline;width:50%">
        <p><label
                for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php _e('Show excerpt:', 'super_recent_posts'); ?></label>
            <br/> <input type="checkbox" id="<?php echo $this->get_field_id('show_excerpt'); ?>"
                         name="<?php echo $this->get_field_name('show_excerpt'); ?>" <?php if ($instance['show_excerpt']) echo 'checked="checked"'; ?> >
        </p></div>

    <div style="float:right;display:inline;width:50%">
        <p><label
                for="<?php echo $this->get_field_id('excerpt_length'); ?>"><?php _e('Excerpt words count:', 'super_recent_posts'); ?></label>
            <br/> <input type="text" id="<?php echo $this->get_field_id('excerpt_length'); ?>"
                         name="<?php echo $this->get_field_name('excerpt_length'); ?>"
                         value="<?php echo $instance['excerpt_length']; ?>" style="width:30px">
        </p></div>
    <p>
        <label for="<?php echo $this->get_field_id('excerpt_readmore'); ?>"><?php _e('Read more text:', 'super_recent_posts'); ?></label>
        <input id="<?php echo $this->get_field_id('excerpt_readmore'); ?>"
               name="<?php echo $this->get_field_name('excerpt_readmore'); ?>"
               value="<?php echo $instance['excerpt_readmore'] ?>" style="width:90px">
    ...
    <div style="float:left;display:inline;width:40%">
        <p><label
                for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php _e('Show thumbnail:', 'super_recent_posts'); ?></label>
            <br/> <input type="checkbox" id="<?php echo $this->get_field_id('show_thumbnail'); ?>"
                         name="<?php echo $this->get_field_name('show_thumbnail'); ?>" <?php if ($instance['show_thumbnail']) echo 'checked="checked"'; ?> >
        </p></div>

    <div style="float:right;display:inline;width:60%">
        <p><label><?php _e('Thumb width,height:', 'super_recent_posts'); ?></label>
            <br/> <input type="text" id="<?php echo $this->get_field_id('thumbnail_w'); ?>"
                         name="<?php echo $this->get_field_name('thumbnail_w'); ?>"
                         value="<?php echo $instance['thumbnail_w']; ?>" style="width:30px">
            x <input type="text" id="<?php echo $this->get_field_id('thumbnail_h'); ?>"
                     name="<?php echo $this->get_field_name('thumbnail_h'); ?>"
                     value="<?php echo $instance['thumbnail_h']; ?>" style="width:30px">
        </p></div>
    <br/>
    <?php
    }
