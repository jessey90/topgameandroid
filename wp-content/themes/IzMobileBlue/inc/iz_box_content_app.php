<?php 
class Iz_Box_Content_App extends WP_Widget
{
    function Iz_Box_Content_App(){
			parent::WP_Widget('Iz_Box_Content_App', 
					'Iz Box Content Top App', 
...
function Iz_Box_Content_AppInit() {
  register_widget('Iz_Box_Content_App');
}
add_action('widgets_init', 'Iz_Box_Content_AppInit');
?>