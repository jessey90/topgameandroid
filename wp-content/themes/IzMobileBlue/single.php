	...
	<div class="iz-box">
		...
		<div class="iz-content-meta">
            ...
            <div class="div2">
                ...
                <a class="btn-download" href="<?php the_field('link_download_game'); ?>" onClick="_gaq.push(['_trackEvent', 'Trang-Chi-Tiet', 'Download-Link: <?php the_field('link_download_game'); ?>', 'Game <?php echo the_title();?>']);">Tải về</a>
            </div>
        </div>
