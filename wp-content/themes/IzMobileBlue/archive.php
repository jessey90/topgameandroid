...
<div class="iz-box">
		...
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url">
					...
					<h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Thể Loại <?php single_cat_title(); ?></h2>
				</a>
			</span>
		</div>		
	<?php /* If this is a tag archive */ } elseif(is_tag()) { ?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Tương Thích <?php single_tag_title(); ?></h2></a>
			</span>
		</div>
	<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Ngày <?php the_time('d/m/Y'); ?></h2></a>
			</span>
		</div>
	<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Tháng <?php the_time('m/Y'); ?></h2></a>
			</span>
		</div>
	<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Năm <?php the_time('Y'); ?></h2></a>
			</span>
		</div>
	<?php /* If this is an author archive */ } elseif (is_author()) {?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Của <?php the_author(); ?></h2></a>
			</span>
		</div>
	<?php /* If this is a paged archive */ } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
		<div class="iz-title" xmlns:v="http://rdf.data-vocabulary.org/#">
			<span typeof="v:Breadcrumb">
				<a href="<?php echo get_category_link( get_cat_ID( single_cat_title( '', false )) );?>" property="v:title" rel="v:url"><h2><img src="<?php echo get_template_directory_uri().'/images/default.png';?>"/>Lưu Trữ</h2></a>
			</span>
		</div>
	<?php } ?>
