<?php 
class Iz_Box_Content_Random extends WP_Widget
{
    function Iz_Box_Content_Random(){
			parent::WP_Widget('Iz_Box_Content_Random', 
					'Iz Box Content Random', 
            array('description' => 'Hiển thị ngẫu nhiên các bài viết.'));
    }
...
function Iz_Box_Content_RandomInit() {
  register_widget('Iz_Box_Content_Random');
}
add_action('widgets_init', 'Iz_Box_Content_RandomInit');
?>